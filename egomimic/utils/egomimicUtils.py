...
ARIA_INTRINSICS = np.array(
    [
        [394.554, 0.0,328.661, 0],
        [0.0, 394.554, 239.531, 0],
        [0.0, 0.0, 1.0, 0],
    ]
)
...
EXTRINSICS = {
    "ariaJul29": {
        "left": np.array([
            [ 0.05648768, -0.52193471,  0.85111298, -0.01795197],
            [-0.99840061, -0.02755412,  0.0493658 , -0.31403709],
            [-0.00231405, -0.85254028, -0.52265641,  0.616188  ],
            [ 0.        ,  0.        ,  0.        ,  1.        ]
       ]),

       "right": np.array([
            [ 0.03572833, -0.56207158,  0.82631654, -0.05054071],
            [-0.99748981,  0.03052483,  0.06389293,  0.30780275],
            [-0.06113557, -0.82652512, -0.55957007,  0.65553019],
            [ 0.        ,  0.        ,  0.        ,  1.        ]
       ])
    },
    "ariaJul29L": np.array([
...
class AlohaFK:
    def __init__(self):
        ...
        self.chain = pk.build_serial_chain_from_urdf(
            open(urdf_path).read(), "gripper_base"
        )
